...
| `skills/web-ai/` | 3 | 973 | bundled agent workflow skill |
| `web-ai/` | 123 | 36672 | provider automation, sessions, MCP, eval, policy, trace |
...
| `test/unit/` | 180 | 31743 | deterministic module tests |
...
| `docs/` | 42 | 4153 | adoption, trace, production-readiness, comparison, benchmark, EXTERNAL_CDP, migration docs, GitHub Pages developer docs |
...
| 파일 | 라인 수 | 설명 |
| --- | ---: | --- |
| `skills/browser/browser.mjs` | 3803 | root CLI parser, Chrome lifecycle, browser primitive commands |
...
| `web-ai/chatgpt.mjs` | 2982 | ChatGPT provider send/poll/query/status with streaming-safe recovery gates |
...
| `web-ai/mcp-server.mjs` | 499 | stdio JSON-RPC MCP bridge |
